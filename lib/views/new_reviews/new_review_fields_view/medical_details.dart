                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton2<String>(
                            ...
                            items: controller.specialityDropdownItems
                                ...
                                .toList(),
                            value: controller.selectedValue.value, // Selected ID
                            onChanged: (value) {
                                        ...
                                        return Obx(() {
                                          return ListTile(
                                            ...
                                            trailing: GestureDetector(
                                              onTap: () {
                                                var selectedQuestion = controller
                                                    .questionData[index];
                                                // Ensure you're adding both 'id' and 'question'
                                                if (!controller.selectedQuestions
                                                    .any((q) =>
                                                        q['id'] ==
                                                        selectedQuestion.id)) {
                                  ...
                                  () => ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      var selectedQuestion =
                                          controller.selectedQuestions[index];
                                      return ListTile(
                                        contentPadding: EdgeInsets.all(0),
                                        title: Text(selectedQuestion['question']),
                                        trailing: SizedBox(
                                          width: 56,
                                          child: Row(
                                            mainAxisAlignment:
                                ...
                                Obx(() => ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return ListTile(
                                          ...
                                          trailing: IconButton(
                                              onPressed: () {
                                                controller.customQuestions.remove(
                                                    controller
                            ...
                            if (questionController.text.isNotEmpty) {
                              addCasequestionstatus =
                                  await controller.addcaseQuestions(
                                      caseId: controller.reviewPatientModel.value
                                          ?.Data[0][0].id,
