...
class CreateReviewController extends GetxController {
  ...
  int maxlines = 5;
  RxList<String> medicalreports = <String>[].obs;
  RxList<String> medicalreportspath = <String>[].obs;
  List imgInBytesList = [];
  RxList<String> dicomreports = <String>[].obs;
  RxList<String> dicomreportspath = <String>[].obs;
